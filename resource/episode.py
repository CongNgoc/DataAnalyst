...
frequent = w.discover_frequent_episodes(29, 68, 5, 0.1)
print('\n'.join('{}: {}'.format(*k) for k in enumerate(frequent)))
print("----------------------------------")
rule = w.generate_rules(29, 68, 5, 0.1, 0.1)
print('\n'.join('{}: {}'.format(*k) for k in enumerate(rule)))
...
# episodes2 = sorted(['A', 'B', 'C', 'D', 'AB', 'AC', 'AD', 'BC', 'BD', 'CD', 'ABC', 'ABD', 'CBD', 'ABCD'])
# w2 = WINEPI(sequence2, episodes2, 'parallel')

# frequent2 = w2.discover_frequent_episodes(10, 80, 50, 0.4)
# print('\n'.join('{}: {}'.format(*k) for k in enumerate(frequent2)))
# print("----------------------------------")
# rule2 = w2.generate_rules(10, 80, 50, 0.4, 0.4)
# print('\n'.join('{}: {}'.format(*k) for k in enumerate(rule2)))