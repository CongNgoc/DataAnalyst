...
def caculateValue(value_of_element, low_value, high_value):
    result_value = "NA";
...
def setValueForMainAttribute(value_of_element, value):
    result_value = "NA";
    if(value_of_element != "NA"):
        value_of_element = float(value_of_element);
...
def writeCSV(file_csv_output, file_txt_input):
    ...
    with open(file_txt_input,'r') as f:
        for line in f:
            ...
            for word in line.split():               
                if(column_number == 0):
                    word = caculateValue(value_of_element = word, low_value = 20, high_value = 30);
                    ...
                    word = caculateValue(value_of_element = word, low_value = 200, high_value = 300);
                    data_each_row.append(word);

                elif(column_number == 3):
                    word = caculateValue(value_of_element = word, low_value = 100, high_value = 150);
                    data_each_row.append(word);

                elif(column_number == 4):
                    word = caculateValue(value_of_element = word, low_value = 3000, high_value = 4000);
                    data_each_row.append(word);

                elif(column_number == 5):
                    decided_attr = setValueForMainAttribute(value_of_element = word, value = 10);
...
writeCSV(file_csv_output = '../resource/CSV_output.csv', file_txt_input = '../resource/cars_data.txt');
